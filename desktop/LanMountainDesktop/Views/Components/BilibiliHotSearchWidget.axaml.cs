...
public partial class BilibiliHotSearchWidget : UserControl, IDesktopComponentWidget, IRecommendationInfoAwareComponentWidget, ISettingsAwareComponentWidget
{
    ...
    private void ApplySnapshot(BilibiliHotSearchSnapshot snapshot)
    {
        ...
        _searchPageUrl = ExternalLinkLauncher.NormalizeHttpUrl(snapshot.SearchUrl) ?? BuildDefaultSearchPageUrl();
    ...
    private void OnSearchBoxPointerPressed(object? sender, PointerPressedEventArgs e)
    {
        ...
        ExternalLinkLauncher.TryOpen(_searchPageUrl);
        e.Handled = true;
    }
