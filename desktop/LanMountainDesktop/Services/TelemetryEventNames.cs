...
internal static class TelemetryEventNames
{
    ...
    internal const string AirAppInstalled = "plugin_installed";
    internal const string AirAppUninstalled = "plugin_uninstalled";
    internal const string AirAppEnabled = "plugin_enabled";
    internal const string AirAppDisabled = "plugin_disabled";
    ...
    private static readonly Dictionary<string, string> EventDisplayNames = new()
    {
        ...
        [ThemeChanged] = "主题变更",
        [AirAppInstalled] = "插件安装",
        [AirAppUninstalled] = "插件卸载",
        [AirAppEnabled] = "插件启用",
        [AirAppDisabled] = "插件禁用",
        [UpdateChecked] = "更新检查",
