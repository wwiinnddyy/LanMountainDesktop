...
internal static class AirAppAppearanceSnapshotMapper
{
    ...
    public static AirAppAppearanceSnapshot FromMaterialColorSnapshot(MaterialColorSnapshot snapshot)
    {
        ...
        return new AirAppAppearanceSnapshot(
            AirAppCornerRadiusTokens.FromShared(snapshot.CornerRadiusTokens),
            ...
            snapshot.Surfaces.ToDictionary(
                ...
                pair => new AirAppMaterialSurfaceSnapshot(
    ...
    /// </summary>
    public static AirAppAppearanceSnapshot FromCompatibilityAppearanceSnapshot(AppearanceThemeSnapshot snapshot)
    {
        ArgumentNullException.ThrowIfNull(snapshot);
