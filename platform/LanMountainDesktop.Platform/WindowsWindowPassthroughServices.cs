...
public sealed class WindowsWindowBottomMostService : IWindowBottomMostService
{
    ...
    private static void LogPositionFailureOnce(DesktopWindowState state, string message)
    {
        ...
        PlatformLog.Warn("WindowBottomMost", message);
...
public sealed class WindowsRegionPassthroughService : IRegionPassthroughService
{
