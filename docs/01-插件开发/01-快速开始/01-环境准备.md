...
<Project Sdk="Microsoft.NET.Sdk">
  ...
  <ItemGroup>
    <!-- Plugin SDK（v6 起包含共享契约依赖 LanMountainDesktop.Core） -->
    <PackageReference Include="LanMountainDesktop.PluginSdk" Version="6.0.0" />
...
```powershell
# 确认引用了 PluginSdk
dotnet add package LanMountainDesktop.PluginSdk --version 6.0.0
