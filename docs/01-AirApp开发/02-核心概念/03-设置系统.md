...
阑山桌面提供了统一的设置系统，用于管理应用、轻应用和组件的配置数据。
...
创建 `Settings/MyAirAppSettingsPage.axaml`：

```xml
<UserControl xmlns="https://github.com/avaloniaui"
             xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml"
             xmlns:vm="using:MyAirApp.ViewModels"
             x:Class="MyAirApp.Settings.MyAirAppSettingsPage"
             x:DataType="vm:MyAirAppSettingsViewModel">
  
  <ScrollViewer>
    <StackPanel Spacing="16" Margin="24">
      
      <!-- 页面标题 -->
      <TextBlock Text="天气轻应用设置"
                 FontSize="24"
                 FontWeight="Bold"
                 Margin="0,0,0,8" />
...
创建 `ViewModels/MyAirAppSettingsViewModel.cs`：
...
namespace MyAirApp.ViewModels;

public partial class MyAirAppSettingsViewModel : ObservableObject
{
    private readonly ISettingsService _settings;
    private readonly ILogger _logger;
    
    public MyAirAppSettingsViewModel(
    ...
    public async Task InitializeAsync(IAirAppRuntimeContext context)
    {
        ...
        if (settingsRegistry != null)
        {
            ...
            settingsRegistry.RegisterPage(
                title: "天气轻应用",
                category: "轻应用",
                icon: "avares://MyAirApp/Assets/settings-icon.png",
                pageFactory: () =>
                {
                    var viewModel = new MyAirAppSettingsViewModel(
                        context.Settings,
                        context.Logger
                    );
                    
                    return new MyAirAppSettingsPage
                    {
...
// 使用
var config = settings.GetValue<AirAppConfig>("Config", new AirAppConfig());
config.Validate();
