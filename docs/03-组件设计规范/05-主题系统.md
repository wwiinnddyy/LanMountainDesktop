...
public class IconHelper
{
    public static string GetThemedIcon(string iconName, Theme theme)
    {
        if (theme == Theme.Dark)
        {
            return $"avares://MyAirApp/Assets/Icons/Dark/{iconName}.png";
        }
        else
        {
            return $"avares://MyAirApp/Assets/Icons/Light/{iconName}.png";
        }
    }
}
```
...
public class WeatherComponent : ComponentBase
{
    ...
    private void UpdateWeatherIcon()
    {
        ...
        WeatherIconPath = $"avares://MyAirApp/Assets/Icons/{themePath}/sunny.png";
    }
}
```
...
<!-- ❌ 假设总是亮色主题 -->
<Image Source="avares://MyAirApp/Assets/white-icon.png"/>
<!-- 在暗色主题下看不见 -->
```
...
- [组件系统](../01-轻应用开发/02-核心概念/02-组件系统.md) - 组件开发
