...
| 产品定位与阶段 | `docs/00-快速开始/01-项目介绍.md`、`docs/archive/PRODUCT.md` | 不再使用旧根目录产品文档 |
| 架构与模块职责 | `docs/04-架构与实现/01-整体架构.md`（历史归档见 `docs/archive/ARCHITECTURE.md`） | 包含仓库结构和运行时主线 |
| 构建、运行、测试、打包 | `docs/archive/DEVELOPMENT.md`（待迁入新结构） | 命令以这里为准 |
| 贡献和文档更新规则 | `docs/archive/CONTRIBUTING.md` | PR、spec、文档协作规则 |
