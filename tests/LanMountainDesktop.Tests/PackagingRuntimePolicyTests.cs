...
public sealed class PackagingRuntimePolicyTests
{
    ...
    {
        var script = ReadRepositoryFile("desktop", "LanMountainDesktop", "scripts", "package.ps1");
    ...
    {
        var script = ReadRepositoryFile("desktop", "LanMountainDesktop", "scripts", "Optimize-PublishPayload.ps1");
    ...
    {
        var project = ReadRepositoryFile("airapp", "LanMountainDesktop.AirAppRuntime", "LanMountainDesktop.AirAppRuntime.csproj");
    ...
    {
        var installer = ReadRepositoryFile("desktop", "LanMountainDesktop", "installer", "LanMountainDesktop.iss");
