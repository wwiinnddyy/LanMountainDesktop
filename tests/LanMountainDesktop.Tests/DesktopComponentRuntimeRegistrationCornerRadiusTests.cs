...
public sealed class DesktopComponentRuntimeRegistrationCornerRadiusTests
{
    ...
    public void LegacyCellSizeResolver_ReturnsUnscaledFixedValue()
    {
        ...
        var resolver = Assert.IsType<Func<AirAppComponentChromeContext, double>>(registration.CornerRadiusResolver);
    ...
    private static AirAppComponentChromeContext CreateChromeContext(double cellSize)
    {
