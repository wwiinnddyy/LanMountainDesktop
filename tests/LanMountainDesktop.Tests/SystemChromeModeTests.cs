...
public sealed class SystemChromeModeTests
{
    ...
    {
        var source = ReadRepositoryFile("desktop", "LanMountainDesktop", "Views", "SettingsWindow.axaml.cs");
    ...
    {
        var source = ReadRepositoryFile("desktop", "LanMountainDesktop", "Views", "ComponentEditorWindow.axaml.cs");
        var applyChromeMode = ExtractMethodSource(source, "ApplyChromeMode");
    ...
    {
        var source = ReadRepositoryFile("desktop", "LanMountainDesktop", "Services", "Settings", "SettingsDomainServices.cs");
