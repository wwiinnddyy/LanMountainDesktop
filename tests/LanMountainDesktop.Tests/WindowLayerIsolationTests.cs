...
public sealed class WindowLayerIsolationTests
{
    ...
    {
        var source = ReadRepositoryFile("airapp", "LanMountainDesktop.AirAppHost", "AirAppWindow.axaml.cs");
    ...
    {
        var xaml = ReadRepositoryFile("airapp", "LanMountainDesktop.AirAppHost", "AirAppWindow.axaml");
        var source = ReadRepositoryFile("airapp", "LanMountainDesktop.AirAppHost", "AirAppWindow.axaml.cs");
    ...
    {
        var source = ReadRepositoryFile("airapp", "LanMountainDesktop.AirAppHost", "AirAppWindowDescriptor.cs");
    ...
    {
        var source = ReadRepositoryFile("airapp", "LanMountainDesktop.AirAppHost", "AirAppWindow.axaml.cs");
        var viewXaml = ReadRepositoryFile("airapp", "LanMountainDesktop.AirAppHost", "ClockAirAppView.axaml");
        var projectFile = ReadRepositoryFile("airapp", "LanMountainDesktop.AirAppHost", "LanMountainDesktop.AirAppHost.csproj");
    ...
    {
        var source = ReadRepositoryFile("desktop", "LanMountainDesktop", "Views", "MainWindow.ComponentSystem.cs");
    ...
    {
        var source = ReadRepositoryFile("desktop", "LanMountainDesktop", "Views", "Components", "AnalogClockWidget.axaml.cs");
    ...
    {
        var appXaml = ReadRepositoryFile("airapp", "LanMountainDesktop.AirAppHost", "AirApp.axaml");
        var projectFile = ReadRepositoryFile("airapp", "LanMountainDesktop.AirAppHost", "LanMountainDesktop.AirAppHost.csproj");
    ...
    {
        var optionsSource = ReadRepositoryFile("airapp", "LanMountainDesktop.AirAppHost", "AirAppLaunchOptions.cs");
        var programSource = ReadRepositoryFile("airapp", "LanMountainDesktop.AirAppHost", "Program.cs");
        var starterSource = ReadRepositoryFile("airapp", "LanMountainDesktop.AirAppRuntime", "IAirAppProcessStarter.cs");
        var dataPathSource = ReadRepositoryFile("desktop", "LanMountainDesktop", "Services", "AppDataPathProvider.cs");
    ...
    {
        var desktopWidgetWindow = ReadRepositoryFile("desktop", "LanMountainDesktop", "Views", "DesktopWidgetWindow.axaml.cs");
    ...
    {
        var source = ReadRepositoryFile("desktop", "LanMountainDesktop", "Services", "FusedDesktopManagerService.cs");
    ...
    {
        var source = ReadRepositoryFile("desktop", "LanMountainDesktop", "App.axaml.cs");
    ...
    {
        var viewModelSource = ReadRepositoryFile("desktop", "LanMountainDesktop", "ViewModels", "SettingsViewModels.cs");
        var pageSource = ReadRepositoryFile("desktop", "LanMountainDesktop", "Views", "SettingsPages", "DevSettingsPage.axaml.cs");
        var xamlSource = ReadRepositoryFile("desktop", "LanMountainDesktop", "Views", "SettingsPages", "DevSettingsPage.axaml");
